...
If you build or server-render on Node.js 20, upgrade to 22.12 or later before taking this version.
Installing on an older release will fail the `engines` check. Nothing changes for browsers or for
bundled output.
